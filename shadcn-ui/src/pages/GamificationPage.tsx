...
import { Trophy, Target, Flame, Star, Award, TrendingUp, Crown, Zap, Heart, Activity, Loader2 } from 'lucide-react';
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            <div className="text-center p-4 bg-gradient-to-br from-red-50 to-red-100 rounded-lg">
              <p className="text-3xl font-bold text-red-600">{progress?.stats?.bloodPressureReadings || 0}</p>
              <p className="text-sm text-gray-600 mt-1">BP Readings</p>
            </div>
            <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg">
              <p className="text-3xl font-bold text-blue-600">{progress?.stats?.bloodGlucoseReadings || 0}</p>
              <p className="text-sm text-gray-600 mt-1">Glucose Checks</p>
            </div>
            <div className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-lg">
              <p className="text-3xl font-bold text-green-600">{progress?.stats?.medicationsTaken || 0}</p>
              <p className="text-sm text-gray-600 mt-1">Medications</p>
            </div>
            <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg">
              <p className="text-3xl font-bold text-purple-600">{progress?.stats?.careTasksCompleted || 0}</p>
              <p className="text-sm text-gray-600 mt-1">Care Tasks</p>
            </div>
            <div className="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg">
              <p className="text-3xl font-bold text-orange-600">{progress?.stats?.appointmentsAttended || 0}</p>
