...
// Note: MongoDB connection should be configured via environment variables
// Do not hardcode credentials in source code
export const MONGODB_CONFIG = {
  uri: process.env.VITE_MONGODB_URI || 'mongodb+srv://<username>:<password>@cluster0.c2havli.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0',
  dbName: process.env.VITE_MONGODB_DB_NAME || 'healthcare_dashboard',
  options: {
    maxPoolSize: 10,
